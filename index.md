                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="divider-wrapper divider-one questions">
                                <i class="fa fa-laptop"></i>
                                <h2>About page</h2>
                                <p>Simple House is a light-weight CSS template for your restaurant or cafe website. This is a custom responsive minimal layout.</p>
                                <input type="text" class="textbox" id="txbx1">
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="divider-wrapper divider-two questions">
                        ...
                        <div class="col-md-4 col-sm-12">
                            <div class="divider-wrapper divider-three questions">
